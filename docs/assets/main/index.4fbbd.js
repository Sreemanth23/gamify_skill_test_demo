...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './Main.ts', './Test1.ts', './Test2.ts'], function () {
  return {
...
System.register("chunks:///_virtual/Main.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      var _dec, _class;
      cclegacy._RF.push({}, "0dbffaagVtE/ps2opmNa5pt", "Main", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var Main = exports('Main', (_dec = ccclass('Main'), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        _proto.test1Click = function test1Click() {
          director.loadScene("Test1");
        };
        _proto.test2Click = function test2Click() {
...
System.register("chunks:///_virtual/Test1.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, director, Component;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      var _dec, _class;
      cclegacy._RF.push({}, "580014knuhH+LdOwks/BC7d", "Test1", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var Test1 = exports('Test1', (_dec = ccclass("Test1"), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        _proto.backButton = function backButton() {
...
System.register("chunks:///_virtual/Test2.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Prefab, Node, Color, instantiate, Label, Sprite, macro, director, Component;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "73feeJwfXxP5rR3KDkOcgU+", "Test2", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var Test2 = exports('Test2', (_dec = ccclass("Test2"), _dec2 = property(Prefab), _dec3 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        _proto.creatingCells = function creatingCells() {
          this.count += 1;
        ...
        _proto.buttonOn = function buttonOn() {
          var _this2 = this;
          this.schedule(function () {
            _this2.node.children[0].active = false;
            _this2.scheduleOnce(function () {
              _this2.node.children[0].destroy();
              _this2.creatingCells();
            }, 0.8);
